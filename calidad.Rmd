...
- Elementos generales del estándar INE

--

- Conceptos generales del paquete `survey`

--

- Uso básico del paquete `calidad`

--

**Objetivo del taller**

- Habilitar a los asistentes en el uso del paquete calidad
...
Nos permite determinar si una estimación es no **fiable, poco fiable o no fiable** 
...
.center[
<img src="imagenes/lumley_ine.png" width="350" />
]
...
Usaremos los datos del trimestre NDE-2020 
...
.center[
### El paque survey en una gran herramienta que nos hace la vida más fácil 
]
...
- Utilizar la función `create_ratio` 
...
Para calcular la media por sexo, usamos la función `create_mean`
...
Queremos calcular el intervalo de confianza par ala media de edad
