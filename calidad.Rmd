...
- Bienvenida de Leonardo González, Subdirector Técnico
...
.center[
<img src="imagenes/flujo.png" width="600" />
]
...
```{r}
library(survey)
dc <- svydesign(ids = ~conglomerado, strata = ~estrato,
                weights = ~fact_cal,  data = ene )
```
